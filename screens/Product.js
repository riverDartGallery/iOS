...
import { Block, Text, Icon, Button, theme } from 'galio-framework';
import glowTheme from '../constants/Theme';
  ...
  renderSize = (label) => {
    ...
    return (
      <TouchableHighlight
        ...
        underlayColor={glowTheme.COLORS.PRICE_COLOR}
    ...
    return (
      <Block style={styles.chatContainer}>
        <Button
          ...
          opacity={0.9}
          style={styles.chat}
          color={glowTheme.COLORS.BUTTON_COLOR}
          onPress={() => navigation.navigate('Chat')}>
          <Icon size={16} family="Galio" name="chat-round" color="white" />
        </Button>
      </Block>
    )
  }
...
const styles = StyleSheet.create({
  ...
  size: {
    ...
    borderBottomColor: glowTheme.COLORS.BORDER_COLOR,
    overflow: 'hidden',
  },
  sizeButton: {
    height: theme.SIZES.BASE * 3,
  ...
  active: {
    backgroundColor: glowTheme.COLORS.PRICE_COLOR,
  },
  roundTopLeft: {
    borderTopLeftRadius: 4,
    borderRightColor: glowTheme.COLORS.BORDER_COLOR,
  ...
  roundTopRight: {
    ...
    borderLeftColor: glowTheme.COLORS.BORDER_COLOR,
    borderLeftWidth: 0.5,
  },
  roundBottomRight: {
