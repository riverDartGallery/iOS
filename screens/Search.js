...
import { products, materialTheme, Images } from '../constants/';
  ...
  renderSearch = () => {
    ...
    const iconSearch = (search ?
      <TouchableWithoutFeedback onPress={() => this.setState({ search: '' })}>
        <Icon size={16} color={theme.COLORS.MUTED} name="simple-remove" family="Galio" />
      </TouchableWithoutFeedback> :
      <Icon size={16} color={theme.COLORS.MUTED} name="zoom-split" family="Galio" />
    )
