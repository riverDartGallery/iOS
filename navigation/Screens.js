...
const HomeStack = createStackNavigator({
  ...
  SignIn: {
    screen: SignInScreen,
    navigationOptions: ({ navigation }) => ({
      header: <Header back transparent white title="Sign In" navigation={navigation} />,
      headerTransparent: true,
    })
  },
  SignUp: {
    screen: SignUpScreen,
    navigationOptions: ({ navigation }) => ({
      header: <Header back transparent white title="Create Account" navigation={navigation} />,
      headerTransparent: true,
    })
  },
},
